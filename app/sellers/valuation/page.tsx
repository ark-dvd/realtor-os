              ...
              >
                ...
                <div className="grid grid-cols-3 gap-3 sm:gap-6">
                  <div>
                    ...
                    <select name="beds" className="input-field h-12 text-base" defaultValue="4">
                  ...
                  <div>
                    ...
                    <select name="baths" className="input-field h-12 text-base" defaultValue="2.5">
                      <option value="1">1</option>
                  ...
                  <div>
                    ...
                    <input type="number" name="sqft" inputMode="numeric" className="input-field h-12 text-base" placeholder="2000" />
                  </div>
                </div>
            ...
            <div>
              ...
              <div className="mt-12 pt-8 border-t border-neutral-200">
                ...
                <div className="space-y-2">
                  <Link
                    href="/sellers/list"
                    className="block text-brand-gold hover:underline active:opacity-70 py-2"
                  >
