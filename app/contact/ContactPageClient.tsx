...
export default function ContactPageClient({ settings }: ContactPageClientProps) {
  ...
  const officeHours = settings.officeHours || 'Monday - Friday: 9am - 6pm\nSaturday: 10am - 4pm\nSunday: By appointment'
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20">
            ...
            <div className="order-1 lg:order-2">
              ...
              <div className="flex items-center gap-6 mb-10">
                ...
                <div>
                  <h3 className="font-display text-2xl text-brand-navy">{agentName}</h3>
                  <p className="text-neutral-500">{settings.agentTitle || 'REALTOR® | Austin Specialist'}</p>
                </div>
              </div>
              ...
              <div className="space-y-6 mb-10">
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-lg text-brand-navy whitespace-pre-line">
                      {address}
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-brand-navy whitespace-pre-line">
                      {officeHours}
                    </p>
                  </div>
                </div>
